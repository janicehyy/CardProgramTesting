...
class __TwigTemplate_8285176593b02baf9a0f64be44d371038f127675e2dcbfd83798ffcb205362ff extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t  <input type=\"number\" name=\"people\" value=\"";
        ...
        echo "\" min=0 placeholder=\"";
        echo ($context["entry_people"] ?? null);
        echo "\" id=\"input-people\" class=\"form-control\" />
\t\t\t\t\t  ";
        // line 38
        if (($context["error_invalid"] ?? null)) {
            // line 39
            echo "\t\t\t\t\t  <div class=\"text-danger text-center\">";
            echo ($context["error_invalid"] ?? null);
            echo "</div>
\t\t\t\t\t  ";
        }
        // line 40
