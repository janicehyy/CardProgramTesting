...
class Customer {
	...
	public function __construct($registry) {
		...
		if (isset($this->session->data['customer_id'])) {
			...
			if ($customer_query->num_rows) {
				...
				$this->telegram_id = $customer_query->row['telegram_id'];
				$this->tradingview_id = $customer_query->row['tradingview_id'];
  ...
  public function login($email, $password, $override = false) {
	...
	public function getTradingViewId() {
		return $this->tradingview_id;
	}
